...
class PDFTemplateView(TemplateView):
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        d= 'The co-founders agreed to build system that used standard browser capabilities and provided an abstraction' 
        # d = 'Router 892w ในปัจจุบันที่การธุรกิจออนไลน์กำลังขยายตัว ทำให้เว็บไซต์อีคอมเมิร์ซ  ร้านค้าออนไลน์ และโซเชียลเน็ตเวิร์กต่างมีจำนวนผู้ขายเพิ่มขึ้นอย่าง The co-founders agreed to build system that used standard browser capabilities and provided an abstraction มาก การที่มีผู้ขายในตลาดเพิ่มมากขึ้นนั้นดีต่อผู้ซื้อเพราะผู้ซื้อสามารถเปรียบเทียบและเลือกซื้อสินค้าจากผู้ขายที่มีคุณภาพได้ตามต้องการ แต่การตัดสินใจเลือกซื้อสินค้าในร้านใดร้านหนึ่งย่อมต้องมีเงื่อนไขประกอบการเลือก ซื้อมากขึ้น'    

        # d=      'ooooooooo1ooooooooo2ooooooooo3ooooooooo4ooooooooo5oo' 
        # d=      'fffffffff1fffffffff2fffffffff3fffffffff4fffffffff5ff'
        # 
        #   
        # -----------------------------------------------------------    
        # n = 52
        ...
        n=[]
        for i in range(1,1+len(n_vowel)//ele) :
             n.append(n_vowel[ele*i-1])
    ...
    # ---------------------_r_--------------------------------------    
        ...
        proc = word_tokenize(d, engine='newmm')
        # print('proc = ',proc)
        # print('r = ',r)
        ...
        for i in range(len(proc)) :
            ds = len(count_n(proc[i])) - len(vowel_indices(proc[i]))
            tot_s.append(ds)
            index.append(i)
        arr = []
        arrr = []
